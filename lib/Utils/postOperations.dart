...
class PostOperations with ChangeNotifier {
  ...
  Future addLikes(BuildContext context, String postId, String likerId) async {
                      ...
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        return new ListView(
                          ...
                          return ListTile(
                              ...
                              trailing: Provider.of<AuthServiceVM>(context,
                                              listen: false)
                                          .userUid ==
                                      documentSnapshot['userUid']
                                  ? Container(
